...
import { User, Pin, RefreshCw, Copy, Volume2, VolumeX } from "lucide-react";
import { formatDistanceToNow } from "date-fns";
import aiIcon from "../assets/logo-new.png";
...
export const ChatBubble: React.FC<ChatBubbleProps> = ({ 
  ...
  return (
    ...
    >
      {!isUser && (
        <img src={aiIcon} alt="AI Assistant" className="w-6 h-6 rounded-full object-contain bg-white border border-green-200 mt-1" />
      )}
